...
import { fetchFromAPI, updateAvatar, updateInfo } from "../utils/fetchFromAPI";
          ...
          <div className="col-2">
            ...
            <input className="form-control" type="file" id="formFile"
              ...
              onChange={() => {
                ...
                updateAvatar(fromData).then(result => {

                  setAvatar(DOMAIN_BE_IMG + result);
            ...
            <form className="row g-3 text-white">
              ...
              <div className="col-12">
                <button type="button" className="btn btn-primary" onClick={() => {
                  ...
                  updateInfo({ full_name, email, pass_word }).then(result => {
                    alert(result)
                  }).catch(err => console.log(err))
